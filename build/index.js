...
function EditComponent(props) {
  ...
  //DragHandle
  const DragHandle = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_2__.sortableHandle)(() => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex items-center font-bold text-sm space-x-1 hover:cursor-move absolute z-50 top-1 left-[30%] text-red-500"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    className: "bx bx-move text-4xl"
  })));
  ...
  function onSortEnd({
    ...
    let TmpLists = (0,array_move__WEBPACK_IMPORTED_MODULE_3__.arrayMoveImmutable)(lists, oldIndex, newIndex);
    setLists(TmpLists);
    props.setAttributes({
      lists: JSON.stringify(TmpLists)
    });
  }
  // Sortable Item
  const SortableItem = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_2__.sortableElement)(({
    ...
    className: `topnhacai my-3 relative`
    ...
    className: "bg-slate-300 absolute z-40 top-0 left-0 w-6 h-6 rounded-br-full text-sm font-bold"
    ...
    className: "relative flex justify-center items-center w-[180px]"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: item.link,
    target: "_blank",
    rel: "nofollow sponsored noopener",
    className: "w-full bg-[#c00] text-white font-bold text-center px-2 py-1 rounded-md hover:bg-yellow-500"
  }, "Truy c\u1EADp ", item.name), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "absolute top-0 right-4 text-green-500 text-xs",
    onClick: () => editTop(postion)
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    class: "bx bxs-edit"
  }), "Ch\u1EC9nh s\u1EEDa"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "absolute flex items-center bottom-0 right-5 text-red-500 text-xs",
    onClick: () => deleteTop(postion)
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    class: "bx bxs-comment-x text-sm"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "X\xF3a")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  //Sortabel Container
  const SortableContainer = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_2__.sortableContainer)(({
    children
  }) => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, children);
  });
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "top-nha-cai-wrapper-class"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "bg-white rounded-md p-2 space-x-2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "text-2xl font-bold uppercase text-center"
  }, "Block Top nh\xE0 c\xE1i"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    useDragHandle: true,
    lockAxis: "y"
  }, lists.map((item, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SortableItem, {
    key: `item-${index}`,
    item: item,
    postion: index,
    index: index
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("dialog", {
    id: "topnhacaiAdd",
    className: "modal"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: () => document.getElementById("topnhacaiAdd").close()
  }, "\u2715"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "mt-3 text-center text-xl font-bold"
  }, "Th\xEAm m\u1EDBi"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "p-2 text-base"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "flex gap-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "T\xEAn nh\xE0 c\xE1i"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "Name",
    name: "name",
    ...
    placeholder: "T\xEAn nh\xE0 c\xE1i"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mt-1 block w-1/2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    for: "slogan",
    class: "text-sm font-semibold text-gray-500"
  }, "Slogan"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "slogan",
    class: "block w-full rounded-md border border-slate-300 bg-white px-2 py-2 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm",
    onChange: handleAddFormInputChange,
    ...
    for: "giftTitle",
    class: "text-sm font-semibold text-gray-500"
  }, "Ti\xEAu \u0111\u1EC1 Khuy\u1EBFn m\u1EA1i"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "giftTitle",
    class: "block w-full rounded-md border border-slate-300 bg-white px-2 py-2 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm",
    onChange: handleAddFormInputChange,
    placeholder: "Khuy\u1EBFn m\xE3i ch\xEDnh"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mt-1 block w-1/2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    for: "giftDesc",
    class: "text-sm font-semibold text-gray-500"
  }, "M\xF4 t\u1EA3 KM"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "giftDesc",
    class: "block w-full rounded-md border border-slate-300 bg-white px-2 py-2 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm",
    onChange: handleAddFormInputChange,
    placeholder: "KM m\xF4 t\u1EA3"
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "my-6 flex gap-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mt-1 block w-1/2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    for: "link",
    class: "text-sm font-semibold text-gray-500"
  }, "Link nh\xE0 c\xE1i"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "link",
    class: "block w-full rounded-md border border-slate-300 bg-white px-2 py-2 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm",
    onChange: handleAddFormInputChange,
    ...
    type: "submit",
    class: "cursor-pointer rounded-md bg-green-500 px-4 py-2 text-sm font-semibold text-white"
  }, "Th\xEAm m\u1EDBi")))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("dialog", {
    id: "topnhacaiEdit",
    className: "modal"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "modal-box bg-white"
    ...
    type: "hidden",
    name: "id",
    value: editIndex && editIndex.id
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "btn btn-sm btn-circle btn-ghost absolute right-2 top-2",
    onClick: () => document.getElementById("topnhacaiEdit").close()
  }, "\u2715"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "mt-3 text-center text-xl font-bold"
  }, "Ch\u1EC9nh s\u1EEDa"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "p-2 text-base"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "flex gap-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
